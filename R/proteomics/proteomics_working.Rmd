...
ggsave(paste(save_path_figures,"proteomics_fiber_microbe_percent_boxplots.pdf"),width = 5,height=4)
...
t.test(filter(proteo_sum_log_norm_fiber,Timepoint==2)$microbe_percent,filter(proteo_sum_log_norm_fiber,Timepoint==7)$microbe_percent,paired=TRUE)
t.test(filter(proteo_sum_log_norm_fiber,Timepoint==2)$microbe_percent,filter(proteo_sum_log_norm_fiber,Timepoint==6)$microbe_percent,paired=TRUE)
t.test(filter(proteo_sum_log_norm_fiber,Timepoint==2)$microbe_percent,filter(proteo_sum_log_norm_fiber,Timepoint==3)$microbe_percent,paired=TRUE)

t.test(filter(proteo_sum_log_norm_fiber,Timepoint==1)$microbe_percent,filter(proteo_sum_log_norm_fiber,Timepoint==6)$microbe_percent,paired=TRUE)
t.test(filter(proteo_sum_log_norm_fiber,Timepoint==1)$microbe_percent,filter(proteo_sum_log_norm_fiber,Timepoint==3)$microbe_percent,paired=TRUE)
t.test(filter(proteo_sum_log_norm_fiber,Timepoint==1)$microbe_percent,filter(proteo_sum_log_norm_fiber,Timepoint==2)$microbe_percent,paired=TRUE)
